  ...
  return (
    <OrderedList>
      ...
      <li>
        ...
        <OrderedList>
          <li>
            ...
            <a href="http://www.seqlegal.com">(http://www.seqlegal.com)</a>. You must retain the above credit. Use of
            this document without the credit is an infringement of copyright. However, you can purchase from us an
            equivalent document that does not include the credit.
          </li>
        </OrderedList>
      </li>
      <li>
        ...
        <OrderedList>
          ...
          <li>
            ...
            <OrderedList>
              <li>
                (a) we, together with our licensors, own and control all the copyright and other intellectual property
      ...
      <OrderedList>
        <li>
          ...
          <OrderedList>
            ...
            <li>
              (d) use our website services by means of a web browser, subject to the other provisions of these terms and
              conditions.
            </li>
          </OrderedList>
        </li>
        <li>
          4.2 Except as expressly permitted by Section 4.1 or the other provisions of these terms and conditions, you
          must not download any material from our website or save any such material to your computer.
        </li>
        <li>
          4.3 You may only use our website for your own personal and business purposes, and you must not use our website
      ...
      <OrderedList>
        <li>
          ...
          <OrderedList>
            ...
            <li>
              (b) use our website in any way that is unlawful, illegal, fraudulent or harmful, or in connection with any
              unlawful, illegal, fraudulent or harmful purpose or activity;
            </li>
            <li>
              (c) use our website to copy, store, host, transmit, send, use, publish or distribute any material which
            ...
            <li>
              (d) conduct any systematic or automated data collection activities (including without limitation scraping,
              data mining, data extraction and data harvesting) on or in relation to our website without our express
              written consent;
            </li>
            <li>
              (e) access or otherwise interact with our website using any robot, spider or other automated means, except
              for the purpose of search engine indexing;
            </li>
            <li>
              (e) use data collected from our website for any direct marketing activity (including without limitation
      ...
      <li>
        ...
        <OrderedList>
          <li>
            7.1 Optionally, If you register for an account with our website, you will be asked to choose a user ID and
            password.
          </li>
          <li>
            7.2 Your user ID must not be liable to mislead and must comply with the content rules set out in Section 10;
        ...
        <OrderedList>
          <li>
            ...
            <OrderedList>
              ...
              <li>(c) edit your account details, at any time in our sole discretion without notice or explanation.</li>
            </OrderedList>
          </li>
      ...
      <li>
        ...
        <OrderedList>
          ...
          <li>
            9.2 We reserve the right to discontinue or alter any or all of our website services, and to stop publishing
            our website, at any time in our sole discretion without notice or explanation; and save to the extent
            expressly provided otherwise in these terms and conditions, you will not be entitled to any compensation or
            other payment upon the discontinuance or alteration of any website services, or if we stop publishing the
            website.
          </li>
          <li>
      ...
      <li>
        ...
        <OrderedList>
          ...
          <li>
            10.2 The limitations and exclusions of liability set out in this Section and elsewhere in these terms and
            conditions:
            <OrderedList>
          ...
          <li>
            10.5 We will not be liable to you in respect of any business losses, including (without limitation) loss of
          ...
          <li>
            10.8 You accept that we have an interest in limiting the personal liability of our officers and employees
            and, having regard to that interest, you acknowledge that we are a limited liability entity; you agree that
      ...
      <li>
        ...
        <OrderedList>
          ...
          <li>
            11.2 Where we suspend or prohibit or block your access to our website or a part of our website, you must not
            take any action to circumvent such suspension or prohibition or blocking (including without limitation
      ...
      <li>
        ...
        <OrderedList>
          ...
          <li>
            12.2 The revised terms and conditions shall apply to the use of our website from the date of publication of
            the revised terms and conditions on the website, and you hereby waive any right you may otherwise have to be
          ...
          <li>
            ...
            the revised terms and conditions within such period as we may specify, we will disable or delete your
      ...
      <li>
        ...
        <OrderedList>
          <li>
            13.1 You hereby agree that we may assign, transfer, sub-contract or otherwise deal with our rights and/or
            obligations under these terms and conditions.
          </li>
          <li>
            13.2 You may not without our prior written consent assign, transfer, sub-contract or otherwise deal with any
      ...
      <li>
        ...
        <OrderedList>
          <li>
            15.1 A contract under these terms and conditions is for our benefit and your benefit, and is not intended to
            benefit or be enforceable by any third party.
          </li>
          <li>
            15.2 The exercise of the parties' rights under a contract under these terms and conditions is not subject to
      ...
      <li>
        ...
        <OrderedList>
          <li>
            ...
            shall constitute the entire agreement between you and us in relation to your use of our website and shall
      ...
      <li>
        ...
        <OrderedList>
          ...
          <li>
            17.2 Any disputes relating to these terms and conditions shall be subject to the jurisdiction of the courts
