        ...
        <OrderedList>
          ...
          <li>
            ...
            <OrderedList>
              ...
              <li>
                2.2. Usage Data: We may also collect non-personal information about your use of our SaaS platform, such
                as IP address, browser type, operating system, and usage patterns.
              </li>
            </OrderedList>
          </li>
          <li>
          ...
          <OrderedList>
            <li>
              ...
              <OrderedList>
                ...
                <li>
                  5.1.5 Portability: You can request a copy of your personal data in a structured, machine-readable
                  format.
                </li>
          ...
          <li>
            ...
            <OrderedList>
              <li>
                6.1 We take reasonable steps to protect your personal information from unauthorized access, disclosure,
                or alteration. However, no method of transmission over the internet or electronic storage is 100%
          ...
          <li>
            ...
            <OrderedList>
              <li>
                8.1 If you have any questions or concerns about this Privacy Policy or our data practices, please
                contact us at gdpr@ddiware.com.
              </li>
            </OrderedList>
          </li>
        </OrderedList>
