        ...
        <OrderedList>
          <li>
            ...
            <OrderedList>
              <li>
                ...
                website www.costoptix.com.
              </li>
              <li>
                1.2 By using our website, you accept these terms and conditions
                in full; accordingly, if you disagree with these terms and
                conditions or any part of these terms and conditions, you must
                not use our website.
              </li>
              <li>
                1.3 If you register with our website, submit any material to our
                website or use any of our website services, we will ask you to
                expressly agree to these terms and conditions.
              </li>
              <li>
                1.4 Our website uses cookies; by using our website or agreeing
                to these terms and conditions, you consent to our use of cookies
                in accordance with the terms of our privacy and cookies policy.
              </li>
            </OrderedList>
          </li>
          <li>
            ...
            <OrderedList>
              <li>
                ...
                <a href="http://www.seqlegal.com">(http://www.seqlegal.com)</a>.
                You must retain the above credit. Use of this document without
                the credit is an infringement of copyright. However, you can
                purchase from us an equivalent document that does not include
                the credit.
              </li>
            </OrderedList>
          </li>
          <li>
            ...
            <OrderedList>
              ...
              <li>
                3.2 Subject to the express provisions of these terms and
                conditions:
                <OrderedList>
                  <li>
          ...
          <OrderedList>
            ...
            <li>
              4.2 Except as expressly permitted by Section 4.1 or the other
            ...
            <li>
              4.3 You may only use our website for your own personal and
            ...
            <li>
              4.5 Unless you own or control the relevant rights in the material,
              you must not:
              <OrderedList>
                <li>
            ...
            <li>
              4.6 We reserve the right to restrict access to areas of our
          ...
          <OrderedList>
            <li>
              ...
              <OrderedList>
                ...
                <li>
                  (e) use data collected from our website for any direct
          ...
          <li>
            5.3 You must ensure that all the information you supply to us
          ...
          <li>
            ...
            <OrderedList>
              <li>
                6.1 You must not allow any other person to use your credentials
                to access the website.
              </li>
              <li>
                6.2 You must notify us in writing immediately if you become
                aware of any unauthorised use of your access credentials to get
                access to our website.
              </li>
              <li>
                6.3 You must not use any other person's credentials to access
                the website, unless you have that person's express permission to
                do so.
              </li>
            </OrderedList>
          </li>
          <li>
            ...
            <OrderedList>
              <li>
                7.1 Optionally, If you register for an account with our website,
                you will be asked to choose a user ID and password.
              </li>
              <li>
                7.2 Your user ID must not be liable to mislead and must comply
                with the content rules set out in Section 10; you must not use
              ...
              <li>
                7.4 You must notify us in writing immediately if you become
                aware of any disclosure of your password.
              </li>
              <li>
                7.5 You are responsible for any activity on our website arising
          ...
          <li>
            ...
            <OrderedList>
              ...
              <li>
                8.2 You may cancel your account at any time via email request at
                info@ddiware.com
              </li>
            </OrderedList>
          </li>
          <li>
            ...
            <OrderedList>
              ...
              <li>
                9.3 To the maximum extent permitted by applicable law and
                subject to Section 10.1, we exclude all representations and
                warranties relating to the subject matter of these terms and
                conditions, our website and the use of our
              </li>
              website.
            </OrderedList>
          </li>
          <li>
            ...
            <OrderedList>
              ...
              <li>
                ...
                Section and elsewhere in these terms and conditions:
                <OrderedList>
              ...
              <li>
                10.3 To the extent that our website and the information and
                services on our website are provided free of charge, we will not
                be liable for any loss or damage of any nature.
              </li>
              <li>
                10.4 We will not be liable to you in respect of any losses
                arising out of any event or events beyond our reasonable
                control.
              </li>
              <li>
                10.5 We will not be liable to you in respect of any business
              ...
              <li>
                10.6 We will not be liable to you in respect of any loss or
                corruption of any data, database or software.
              </li>
              <li>
                10.7 We will not be liable to you in respect of any special,
                indirect or consequential loss or damage.
              </li>
              <li>
                10.8 You accept that we have an interest in limiting the
            ...
            <OrderedList>
              <li>
                ...
                <OrderedList>
                  ...
                  <li>
                    (e) commence legal action against you, whether for breach of
              ...
              <li>
                11.2 Where we suspend or prohibit or block your access to our
          ...
          <li>
            ...
            <OrderedList>
              ...
              <li>
                ...
                our website from the date of publication of the revised terms
                and conditions on the website, and you hereby waive any right
                you may otherwise have to be notified of, or to consent to,
                revisions of these terms and conditions
              </li>
              <li>
                12.3 If you have given your express agreement to these terms and
                ...
                your account on the website, and you must stop using the
                website.
              </li>
            </OrderedList>
          </li>
          <li>
            ...
            <OrderedList>
              ...
              <li>
                13.2 You may not without our prior written consent assign,
          ...
          <li>
            ...
            <OrderedList>
              ...
              <li>
                14.2 If any unlawful and/or unenforceable provision of these
                terms and conditions would be lawful or enforceable if part of
          ...
          <li>
            ...
            <OrderedList>
              ...
              <li>
                15.2 The exercise of the parties' rights under a contract under
          ...
          <li>
            ...
            <OrderedList>
              <li>
                ...
                the entire agreement between you and us in relation to your use
                of our website and shall supersede all previous agreements
          ...
          <li>
            ...
            <OrderedList>
              <li>
                ...
                construed in accordance with Canadian law.
              </li>
              <li>
                17.2 Any disputes relating to these terms and conditions shall
                be subject to the jurisdiction of the courts of Canada.
              </li>
            </OrderedList>
          </li>
          <li>
            ...
            <OrderedList>
              <li>
                18.1 For contact information send an email to info@ddiware.com
              </li>
            </OrderedList>
          </li>
        </OrderedList>
