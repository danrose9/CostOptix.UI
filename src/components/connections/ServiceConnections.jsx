...
export const ServiceConnections = [
  ...
  {  
    ...
    details: 'Create a connection to the Azure Billing APIs. These can be used to show usage and resource information within your organization. Using this service we can acuratley display costs, usage and compare rates across different regions',
    active: true,
    colorHex: '#7FBA00',
    color: 'blue',
  },
  {  
    ...
    details: 'Connect to your AWS service and gather subscription costs across each of your regions.',
    active: true,
    colorHex: '#FF9900',
    color: 'orange',
  },
