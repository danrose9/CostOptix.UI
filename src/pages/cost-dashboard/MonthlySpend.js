...
import { ChartTooltip } from '../../components/tooltips/index';

export const MonthlySpend = (props) => {
  const monthlyCosts = useSelector(
    (state) => state[reduxState.COST_DASHBOARD].monthlySpend.data
  );

  const isLoading = useSelector(
    (state) => state[reduxState.COST_DASHBOARD].monthlySpend.isLoading
  );
